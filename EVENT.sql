...
BEGIN
    ...
    AND (T.transaction_status IS NULL OR not exists (
    select 1
...
BEGIN
    ...
    DECLARE cur CURSOR FOR 
        ...
        FROM VIP_CLIENTS JOIN locked_shopping_cart ON VID = LCID
        JOIN ISSUED_FOR ON LCID = IID AND ICart_number = Cart_number AND ILocked_Number = CNumber
